...
public class PacManAnimationManager {
    ...
    public void loadpacManImages() {
        try {
            BufferedImage down1 = ImageIO.read(getClass().getResourceAsStream("/view/resources/pacMan/pacmanDown.png"));
            BufferedImage down2 = ImageIO.read(getClass().getResourceAsStream("/view/resources/pacMan/pacmanClosed.png"));
            BufferedImage right1 = ImageIO.read(getClass().getResourceAsStream("/view/resources/pacMan/pacmanRight.png"));
            BufferedImage left1 = ImageIO.read(getClass().getResourceAsStream("/view/resources/pacMan/pacmanLeft.png"));
            BufferedImage up1 = ImageIO.read(getClass().getResourceAsStream("/view/resources/pacMan/pacmanUp.png"));
